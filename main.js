/* FURIA GT-88 — Apple-style scroll film
...
const state = {
  blobs: [],           // Blob per frame (compressed WebP, ~35KB each)
...
function drawFrame(i) {
  ...
  // contain: frames are 16:9, viewport scales nicely — vignette hides seam
...
function devPlaceholder(msg) {
  ...
  const draw = () => {
    ...
    ctx.fillStyle = "rgba(232,92,82,0.85)";
...
loadManifest()
  ...
  .catch(() => devPlaceholder("frames not found — check frames/ directory"));
